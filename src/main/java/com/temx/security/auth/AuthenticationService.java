...
import com.temx.security.email.EmailService;
import com.temx.security.token.Token;
import com.temx.security.token.TokenRepository;
import com.temx.security.token.TokenType;
...
//    emailService.sendEmail(request.getEmail(),"Welcome to our site","your registration is successful and please confirm your email address by clicking the link below" + " https://www.temxtech.vercel.app");
    ...
    return AuthenticationResponse.builder()
        .accessToken(jwtToken)
            ...
            .message("Email sent to your address for confirmation")
        .build();
  }
